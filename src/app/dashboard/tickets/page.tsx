...
import { Loader2, Search, Mail, Phone, Calendar, FileText, Download, ExternalLink } from 'lucide-react';
...
export default function TicketsPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-4xl font-black mb-2">Tickets</h1>
        <p className="text-muted">
          Administra todas las solicitudes de clientes
        </p>
      </div>
      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <Input
            placeholder="Buscar por nombre, email o número de ticket..."
            value={searchQuery}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredLeads.map((lead) => (
          <Card
            key={lead.id}
            className="card-fresh cursor-pointer hover:shadow-lg transition-all"
            ...
            <CardHeader>
              ...
              {lead.ticketNumber && (
                <p className="text-sm text-muted">
                  Ticket: <span className="font-mono font-semibold">{lead.ticketNumber}</span>
                </p>
              )}
            </CardHeader>
